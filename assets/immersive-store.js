...
// Optimization: Cache device flags and layout-dependent values to reduce
// repeated DOM queries and layout reads on high-frequency events.
let isMobile = null;
let isTablet = null;
let usesMobileImg = null;
let canvasRect = null;
...
// Initial evaluation of device flags
evaluateDeviceFlags();
...
function initImmersiveScene() {
  ...
  // Optimization: Throttled resize handler to reduce layout thrashing.
  let resizeRaf = null;
  ...
  function onWindowResize() {
    ...
    resizeRaf = requestAnimationFrame(function () {
      ...
      // Re-render hotspots on resize if mobile/desktop breakpoint crossed
...
function handleMouseMove(event) {
  ...
  // Optimization: Use cached canvasRect to avoid repeated getBoundingClientRect() calls
  var rect = canvasRect;
